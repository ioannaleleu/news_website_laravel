...
<html lang="zxx">
  <head>
    ...
    <title>{{$settings->site_name ?? 'unknown' }}</title>
                ...
                <div class="navbar-bottom">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="social-media">
                      <li>
                        <a href="{{$settings->facebook ?? 'unknown'}}">
                            <i class="mdi mdi-facebook"></i>
                        </a>
                        </li>
                        <li>
                        <a href="{{$settings->youtube ?? 'unknown' }}">
                            <i class="mdi mdi-youtube"></i>
                        </a>
                        </li>
                        <li>
                        <a href="{{$settings->twitter ?? 'unknown' }}">
                            <i class="mdi mdi-twitter"></i>
                        </a>
                        </li>
                        <li>
                          <a href="{{$settings->instagram ?? 'unknown' }}">
                              <i class="mdi mdi-instagram"></i>
                          </a>
                          </li>
                        <li>
                          <a href="{{$settings->linkedin ?? 'unknown' }}">
        ...
        <div class="footer-bottom">
            ...
            <div class="row">
                ...
                <div class="d-sm-flex justify-content-between align-items-center">
                    ...
                    © 2021 @ <a href="/" target="_blank" class="text-white"> {{$settings->site_name ?? 'unknown' }}</a>. All rights reserved.
                    </div>
                    <div class="fs-14 font-weight-600">
